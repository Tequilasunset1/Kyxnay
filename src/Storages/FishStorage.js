...
export class FishStorage extends Storage {
    ...
    constructor() {
        ...
        if(FishStorage.meshSample == undefined) {
            FishStorage.meshSample = new Promise((resolve, reject) => {
                var mtlLoader = new MTLLoader();
                mtlLoader.load('./src/3D_Objects/FishSG.mtl', function(materials) {
                    materials.preload();
                    var objLoader = new OBJLoader();
                    objLoader.setMaterials(materials);
                    objLoader.load('./src/3D_Objects/FishSG.obj', function(object) {
        ...
        FishStorage.meshSample.then((mesh)=>
        {
