...
export class PotatoStorage extends Storage {
    ...
    constructor() {
        ...
        if(PotatoStorage.meshSample == undefined) {
            PotatoStorage.meshSample = new Promise((resolve, reject) => {
                var mtlLoader = new MTLLoader();
                mtlLoader.load('./src/3D_Objects/PotatoSG.mtl', function(materials) {
                    materials.preload();
                    var objLoader = new OBJLoader();
                    objLoader.setMaterials(materials);
                    objLoader.load('./src/3D_Objects/PotatoSG.obj', function(object) {
        ...
        PotatoStorage.meshSample.then((mesh)=>
        {
